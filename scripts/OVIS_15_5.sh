...
EXP_NAME="Video_Instance_15_5_mamba"

STEP_ARGS="CONT.BASE_CLS 15 CONT.INC_CLS 5 CONT.MODE overlap SEED 42"
...
PRETRAINED_PATH="results/Video_ovis_IS/coco2ovis_train_15-5-ov/Video_Instance_15_5_mamba/step0/model_final.pth"
python train_net_hvpl.py --num-gpus ${NGPUS} \
    --config-file ${CFG_FILE} \
