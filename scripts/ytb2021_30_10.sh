...
OUTPUT_BASE="results/Video_yvis2021_IS"
EXP_NAME="Video_Instance_30_10_mamba"

STEP_ARGS="CONT.BASE_CLS 30 CONT.INC_CLS 10 CONT.MODE overlap SEED 42"
...
PRETRAINED_PATH="results/Video_yvis2021_IS/coco2ytvis2021_train_20-4-ov/Video_Instance_20_4_mamba/step0/model_final.pth"
python train_net_hvpl.py --num-gpus ${NGPUS} \
    --config-file ${CFG_FILE} \
