...
EXP_NAME="Video_Instance_20_2_mamba"
...
PRETRAINED_PATH="results/Video_yvis2019_IS/coco2ytvis2019_train_20-2-ov/Video_Instance_20_2_mamba/step0/model_final.pth"
python train_net_hvpl.py --num-gpus ${NGPUS} \
    --config-file ${CFG_FILE} \
